...
class MaxHeap {
    ...
    heapifyDown(index) {
        ...
        if ( this.heap.length > leftChildIndex && this.heap[leftChildIndex] > this.heap[largestIndex]) {
             largestIndex = leftChildIndex;
        }

        if (this.heap.length > rightChildIndex && this.heap[rightChildIndex] > this.heap[largestIndex]) {
